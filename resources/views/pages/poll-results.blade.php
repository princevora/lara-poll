                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-xl-8 col-md-12">
                                <div class="card card-plain">
                                    <div
                                        class="card-body border-top border-5 border-info shadow-lg rounded text-center">
                                                ...
                                                @foreach ($fieldData as $data)
                                                    ...
                                                    @foreach ($fields as $key => $field)
                                                        <div class="mb-3">
                                                            ...
                                                            @php
                                                                $vote = @$chartData
                                                                    ->where('vote_field', '=', $key)
                                                                    ->first()->votes;
                                                                $percentage = number_format(
                                                                    ($vote / $totalVotes) * 100,
                                                                );
                                                                $bgClass =
                                                                    $prePer !== null && $percentage > $prePer
                                                                        ? 'bg-success'
                                                                        : '';
                                                                $prePer = $percentage;
                                                            @endphp
                                                            ...
                                                            <div class="progress" style="height: 18px">
                                                                <div class="progress-bar h-auto {{ $bgClass }}"
                                                                    role="progressbar"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="input-group mb-3">
                                                    <input type="text" value="{{ request()->poll_id }}"
                                                        id="poll_id" style="display: none">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button onclick="sharePoll()"
                                                            ...
                                                            id="basic-addon2" title="Share to anyone"
                                                            data-toggle="tooltip">
                                                            <i class="fa-solid fa-share"></i>
                                                        </button>
                                                    </div>
                                                    <div class="input-group-append">
                                                        <button onclick="copyPollId()"
                                                            class="btn-dark-outline input-group-text text-dark"
                                                            id="basic-addon2" title="Click To Copy"
                                                            data-toggle="tooltip">
